...
The ICU mortality was 52%. We used logistic regression in order to reveal factors associated with primary outcome of the study. 
All continuous variables were checked for linearity beforehand (Figure 2).
